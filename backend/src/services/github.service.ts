...
export class GithubService {
  private github_commit_url = "https://api.github.com/repos/facebook/react/commits";
   ...
   */
  getCommits = async (sha?: string, since?: string, until?: string) => {
    try {
      const options: request.Options = {
        method: "GET",
        uri: this.github_commit_url,
        json: true,
        headers: {
